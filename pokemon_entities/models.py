...
class Pokemon(models.Model):
    ...
    title_ru = models.CharField(
        max_length=200,
        verbose_name="название покемона на русском языке")
    ...
    description = models.TextField(
        ...
        default="Здесь будет описание покемона")
...
class PokemonEntity(models.Model):
    ...
    lat = models.FloatField(
        ...
        verbose_name="широта координат покемона")
    lon = models.FloatField(
        default=0, blank=True, null=True,
        verbose_name="долгота координат покемона")
    appeared_at = models.DateTimeField(
        default=None, blank=True, null=True,
        verbose_name="появление покемона")
    disappeared_at = models.DateTimeField(
        default=None, blank=True, null=True,
        verbose_name="исчезновение покемона")
