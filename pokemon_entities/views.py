...
DEFAULT_IMAGE_URL = "https://vignette.wikia.nocookie.net/pokemon/images/6/6e/%21.png/revision/latest/fixed-aspect-ratio-down/width/240/height/240?cb=20130525215832&fill=transparent"  # noqa
...
def show_all_pokemons(request):
    ...
    for pokemon in pokemons:
        ...
        for location in locations:
            add_pokemon(folium_map, location.lat, location.lon,
                        pokemon.title, request.build_absolute_uri(image_url))
